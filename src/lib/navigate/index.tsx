...
export const pagesHeader = [
	...
	{ name: 'Files', href: '/files', label: 'Files' },
	{ name: 'About', href: '/pages/about', label: 'About' },
]
...
export const pagesUserCab = [
	...
	{ name: 'Notes', href: '/files', label: 'Notes' },
	{ name: 'Benefits', href: '/pages/about', label: 'Benefits' },
	{ name: 'Training', href: '/pages/about', label: 'Training' },
	{ name: 'Assets', href: '/pages/about', label: 'Assets' },
]
